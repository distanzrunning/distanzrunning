...
const defaultCode = `import { Drawer } from '@/components/ui/Drawer';
import Button from '@/components/ui/Button';
...
const customHeightCode = `import { Drawer } from '@/components/ui/Drawer';
import Button from '@/components/ui/Button';
    ...
    <>
      ...
      <Section>
        ...
        <p className="mt-2 leading-6 text-[var(--ds-gray-900)] xl:mt-4">
          Only use a Drawer on small viewports. Shown here at any viewport for
          demonstration.
        </p>
      ...
      {/* Custom Height */}
      <Section>
        <SectionHeader id="custom-height" onCopyLink={showToast}>
          Custom height
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={customHeightCode}>
            <CustomHeightDemo />
          </CodePreview>
        </div>
      </Section>
