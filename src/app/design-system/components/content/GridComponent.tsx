...
function ResponsiveClippingExample() {
  return (
    <Grid rows={2} columns={3}>
...
const hiddenRowGuidesCode = `import { Grid } from '@/components/ui/Grid';

function HiddenRowGuidesExample() {
  return (
    <Grid rows={3} columns={12} hideRowGuides squareCells />
  );
}`;

const hiddenColumnGuidesCode = `import { Grid } from '@/components/ui/Grid';

function HiddenColumnGuidesExample() {
  return (
    <Grid rows={3} columns={12} hideColumnGuides squareCells />
  );
}`;

const overlayingCellsCode = `import { Grid, GridCell } from '@/components/ui/Grid';

function OverlayingCellsExample() {
  return (
...
function SpecificClippingExample() {
  return (
...
function HiddenRowGuidesDemo() {
  return <Grid rows={3} columns={12} hideRowGuides squareCells />;
}

function HiddenColumnGuidesDemo() {
...
export default function GridComponent() {
  ...
  return (
    <>
      <Section>
        <SectionHeader id="grid" onCopyLink={showToast}>
          Grid
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          A non-responsive grid with no cells.
        </p>
        <CodePreview componentCode={gridCode}>
          <GridDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="basic-grid" onCopyLink={showToast}>
          Basic grid
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          A non-responsive single grid with auto flowing cells configuration.
        </p>
        <CodePreview componentCode={basicGridCode}>
          <BasicGridDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="solid-cells" onCopyLink={showToast}>
          Solid cells
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
      ...
      <Section>
        <SectionHeader id="grid-with-hidden-row-guides" onCopyLink={showToast}>
          Grid with hidden row guides
        </SectionHeader>
        <CodePreview componentCode={hiddenRowGuidesCode}>
          <HiddenRowGuidesDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="grid-with-hidden-column-guides" onCopyLink={showToast}>
          Grid with hidden column guides
        </SectionHeader>
        <CodePreview componentCode={hiddenColumnGuidesCode}>
          <HiddenColumnGuidesDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="grid-with-overlaying-cells" onCopyLink={showToast}>
          Grid with overlaying cells
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          Grid component with cells that overlay another in various states.
        </p>
        <CodePreview componentCode={overlayingCellsCode}>
          <OverlayingCellsDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="specific-grid-with-guide-clipping" onCopyLink={showToast}>
