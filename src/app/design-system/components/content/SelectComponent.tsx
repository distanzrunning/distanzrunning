  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 14.5C11.5899 14.5 14.5 11.5899 14.5 8C14.5 4.41015 11.5899 1.5 8 1.5C4.41015 1.5 1.5 4.41015 1.5 8C1.5 11.5899 4.41015 14.5 8 14.5ZM8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16ZM8.75 11.25V11.5H7.25V11.25V6.56066L5.28033 8.53033L4.75 9.06066L3.68934 8L4.21967 7.46967L7.46967 4.21967C7.76256 3.92678 8.23744 3.92678 8.53033 4.21967L11.7803 7.46967L12.3107 8L11.25 9.06066L10.7197 8.53033L8.75 6.56066V11.25Z"
        fill="currentColor"
      />
    </svg>
  );
...
const sizesCode = `import type { JSX } from 'react'
import { Select } from '@/components/ui/Select'
...
export function Component(): JSX.Element {
  return (
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <Select size="medium" prefix={<UploadIcon />}>
        <option disabled selected>With prefix</option>
      </Select>
      <Select size="large" prefix={<UploadIcon />}>
        <option disabled selected>With prefix</option>
      </Select>
    </div>
  )
...
const disabledCode = `import type { JSX } from 'react'
import { Select } from '@/components/ui/Select'

export function Component(): JSX.Element {
  return (
    <Select disabled>
      <option disabled selected>Disabled with placeholder</option>
    </Select>
  )
}`;

const errorCode = `import type { JSX } from 'react'
import { Select } from '@/components/ui/Select'

export function Component(): JSX.Element {
  return (
    <div className="flex flex-col md:flex-row gap-4">
      <Select size="xsmall" error errorMessage="Please select a value.">
        <option disabled selected>XSmall</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
      </Select>
      <Select size="small" error errorMessage="Please select a value.">
        <option disabled selected>Small</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
      </Select>
      <Select size="medium" error errorMessage="Please select a value.">
        <option disabled selected>Default</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
      </Select>
      <Select size="large" error errorMessage="Please select a value.">
        <option disabled selected>Large</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
...
const labelCode = `import type { JSX } from 'react'
import { Select } from '@/components/ui/Select'

export function Component(): JSX.Element {
  return (
    <Select label="My label">
      <option disabled selected>With label</option>
      <option>Option 1</option>
      <option>Option 2</option>
      <option>Option 3</option>
    </Select>
...
function ErrorDemo() {
  return (
    <div className="flex flex-col md:flex-row gap-4 [&>*]:flex-1 items-start">
      ...
      <Select size="small" error={true} errorMessage="Please select a value.">
        <option disabled selected>Small</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
      </Select>
      <Select size="medium" error={true} errorMessage="Please select a value.">
        <option disabled selected>Default</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
      </Select>
      <Select size="large" error={true} errorMessage="Please select a value.">
        <option disabled selected>Large</option>
        <option>Option 1</option>
        <option>Option 2</option>
        <option>Option 3</option>
