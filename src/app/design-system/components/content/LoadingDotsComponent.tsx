...
const defaultCode = `import { LoadingDots } from '@/components/ui/LoadingDots';
...
export default function LoadingDotsComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="with-text" onCopyLink={showToast}>
          With text
        </SectionHeader>
        <div className="mt-6">
          <CodePreview componentCode={withTextCode}>
            <WithTextDemo />
          </CodePreview>
        </div>
      </Section>
