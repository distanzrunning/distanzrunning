...
function VerticalWithButtonsExample(): JSX.Element {
  ...
  const scrollPrev = () => {
    ...
    if (!el) return;
    const child = el.querySelector(':scope > * > *') as HTMLElement;
    if (child) el.scrollBy({ top: -child.offsetHeight, behavior: 'smooth' });
  };
...
function HorizontalWithButtonsExample(): JSX.Element {
  ...
  const scrollPrev = () => {
    ...
    if (!el) return;
    const child = el.querySelector(':scope > * > *') as HTMLElement;
    if (child) el.scrollBy({ left: -child.offsetWidth, behavior: 'smooth' });
  };
...
function VerticalWithButtonsDemo() {
  const scrollerRef = useRef<HTMLDivElement>(null);
...
function HorizontalWithButtonsDemo() {
  const scrollerRef = useRef<HTMLDivElement>(null);
...
export default function ScrollerComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="free" onCopyLink={showToast}>
          Free
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={freeCode}>
            <FreeDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="vertical-with-buttons" onCopyLink={showToast}>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={verticalWithButtonsCode}>
            <VerticalWithButtonsDemo />
          </CodePreview>
        </div>
      </Section>

      <Section>
        <SectionHeader id="horizontal-with-buttons" onCopyLink={showToast}>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={horizontalWithButtonsCode}>
