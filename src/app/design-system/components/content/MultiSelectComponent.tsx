...
const selectActionsCode = `import { MultiSelect } from '@/components/ui/MultiSelect';
...
const keyboardNavCode = `import { MultiSelect } from '@/components/ui/MultiSelect';
import type { JSX } from 'react';
...
export default function MultiSelectComponent() {
  ...
  return (
    <>
      <Section>
        <SectionHeader id="select-actions" onCopyLink={showToast}>
          Select Actions
        </SectionHeader>
        <p
          className="text-copy-16 text-textSubtle mt-3 mb-4"
          style={{ lineHeight: 1.5 }}
        >
          The component provides different selection behaviors based on current
          state:
        </p>
        <ul
        ...
        >
          ...
          <li>
            ...
            : Smart selection (Select Only, Select All, or Toggle based on
            context)
          </li>
          <li>
            <strong className="text-textDefault">Hidden action labels</strong>:
      ...
      <Section>
        <SectionHeader id="keyboard-navigation" onCopyLink={showToast}>
          Keyboard Navigation
        </SectionHeader>
        <p
          className="text-copy-16 text-textSubtle mt-3 mb-4"
        ...
        >
          ...
          <li>
            <strong className="text-textDefault">Left/Right arrows</strong>:
            Switch between checkbox and button focus
          </li>
          <li>
            <strong className="text-textDefault">Tab</strong>: Focus away from
            the menu
          </li>
          <li>
            <strong className="text-textDefault">Enter/Space</strong>: Execute
      ...
      <Section>
        <SectionHeader id="controlled-state" onCopyLink={showToast}>
          Controlled State
        </SectionHeader>
        <p
