...
export default function SkeletonComponent() {
  ...
  return (
    <>
      <Section>
        <SectionHeader id="default-with-set-width" onCopyLink={showToast}>
          Default with set width
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultWithSetWidthCode}>
            <DefaultWithSetWidthDemo />
          </CodePreview>
        </div>
      </Section>

      <Section>
        <SectionHeader id="default-with-box-height" onCopyLink={showToast}>
          Default with box height
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultWithBoxHeightCode}>
            <DefaultWithBoxHeightDemo />
          </CodePreview>
        </div>
      </Section>

      <Section>
        <SectionHeader id="wrapping-children" onCopyLink={showToast}>
          Wrapping children
        </SectionHeader>
        <p
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={wrappingChildrenCode}>
            <WrappingChildrenDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        ...
        <p
          ...
          style={{ color: "var(--ds-gray-900)" }}
        >
          The skeleton will hide when children are not null, but the size is
          retained.
        </p>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={wrappingChildrenFixedSizeCode}>
            <WrappingChildrenFixedSizeDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="squared" onCopyLink={showToast}>
          Squared
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={squaredCode}>
            <SquaredDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="no-animation" onCopyLink={showToast}>
          No animation
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
