...
// ============================================================================
// Inline Toast for Section Link Copy (matches other pages)
// ============================================================================

function LinkCopyToast({
  message,
  isVisible,
  onDismiss,
}: {
...
export default function ToastDSComponent() {
  const {
    toast: linkToast,
    showToast: showLinkToast,
    dismissToast: dismissLinkToast,
  } = useLinkCopyToast();

  return (
    <>
      <Section>
        <SectionHeader id="default" onCopyLink={showLinkToast}>
          Default
        </SectionHeader>
      ...
      <Section>
        <SectionHeader id="multi-line" onCopyLink={showLinkToast}>
          Multi-line
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <Section>
        <SectionHeader id="with-jsx" onCopyLink={showLinkToast}>
          With JSX
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={withJsxCode}>
            <WithJsxDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="with-a-link" onCopyLink={showLinkToast}>
          With a link
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <Section>
        <SectionHeader id="preserve" onCopyLink={showLinkToast}>
          Preserve
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={preserveCode}>
            <PreserveDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="action" onCopyLink={showLinkToast}>
          Action
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <Section>
        <SectionHeader id="undo" onCopyLink={showLinkToast}>
          Undo
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={undoCode}>
            <UndoDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="success" onCopyLink={showLinkToast}>
          Success
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <Section>
        <SectionHeader id="warning" onCopyLink={showLinkToast}>
          Warning
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <Section>
        <SectionHeader id="error" onCopyLink={showLinkToast}>
          Error
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
      ...
      <LinkCopyToast
        ...
        isVisible={linkToast.isVisible}
        onDismiss={dismissLinkToast}
      />
    </>
  );
}
