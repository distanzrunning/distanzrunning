...
const defaultCode = `import { Entity } from '@/components/ui/Entity';
import { Avatar } from '@/components/ui/Avatar';
...
const skeletonCode = `import { Entity } from '@/components/ui/Entity';

function SkeletonExample() {
  return (
    <Entity>
      <div className="flex flex-col gap-2 flex-1">
        <Entity.Skeleton width="100%" height={20} />
        <div className="flex flex-row items-center gap-2">
          <Entity.Skeleton width={70} height={20} />
          <Entity.Skeleton width={60} height={20} />
          <Entity.Skeleton width={68} height={20} />
        </div>
      </div>
    </Entity>
  );
...
export default function EntityComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="entity-with-skeleton" onCopyLink={showToast}>
          Entity with Skeleton
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          Use skeleton placeholders when entity content is loading.
        </p>
        <CodePreview componentCode={skeletonCode}>
          <SkeletonDemo />
        </CodePreview>
      </Section>

      <Section>
        <SectionHeader id="entity-with-list" onCopyLink={showToast}>
          Entity with List
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
      ...
      <Section>
        <SectionHeader id="entity-with-list-and-checkbox" onCopyLink={showToast}>
          Entity with List and Checkbox
        </SectionHeader>
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          Entities in a list with checkboxes for selection. Clicking the row toggles the checkbox.
        </p>
