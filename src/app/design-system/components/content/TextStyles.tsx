  ...
  return (
    <div className="space-y-4">
            ...
            <table className="w-full border-collapse">
              <tbody className="text-sm whitespace-nowrap">
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900 w-24">Style</td>
                  <td className="py-2 px-4 font-medium">Display Large</td>
                </tr>
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Typeface</td>
                  <td className="py-2 px-4">EB Garamond (serif)</td>
                </tr>
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Size</td>
                ...
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Line-height</td>
                ...
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Usage</td>
      ...
      <section>
        ...
        <div className="mb-8">
          <div className="[background:var(--ds-gray-100)] p-6 mb-4">
            <p className="font-sans text-[18px] leading-[1.6] text-gray-1000">
        ...
        <div className="mb-8">
          <div className="[background:var(--ds-gray-100)] p-6 mb-4">
            <p className="font-sans text-base leading-[1.5] text-gray-1000">
        ...
        <div className="mb-8">
          <div className="[background:var(--ds-gray-100)] p-6 mb-4">
            <p className="font-sans text-sm leading-[1.5] text-gray-900">
            ...
            <table className="w-full border-collapse">
              <tbody className="text-sm whitespace-nowrap">
                ...
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Tailwind</td>
                  <td className="py-2 px-4 font-mono text-xs">
                    font-sans text-sm leading-normal text-gray-900
                  </td>
                </tr>
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Usage</td>
      ...
      <section>
        ...
        <div className="mb-8">
          <div className="[background:var(--ds-gray-100)] p-6 mb-4">
            <p className="font-sans text-sm font-medium text-gray-1000">
              Email address
            </p>
          </div>
          <div className="overflow-x-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <tbody className="text-sm whitespace-nowrap">
                ...
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Transform</td>
                  <td className="py-2 px-4">uppercase</td>
                </tr>
                <tr className="border-b border-gray-300">
                  <td className="py-2 pr-4 text-gray-900">Tracking</td>
