  ...
  return (
    <div className="space-y-8">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="font-mono text-xs">
              <tr className="border-b border-borderSubtle">
                <td className="py-3 px-4">--color-asphalt-10</td>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="font-mono text-xs">
              ...
              <tr className="border-b border-borderSubtle">
                ...
                <td className="py-3 px-4">--color-surfaceSubtle</td>
              </tr>
              <tr>
      ...
      <section>
        ...
        <p className="text-base text-textSubtle max-w-3xl mb-6">
          Token names follow a structured pattern that communicates category,
          property, and variant. Names are human-readable and use kebab-case.
        </p>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex gap-4">
            <span className="font-mono text-sm text-electric-pink w-24">
              category
            </span>
            <span className="text-sm text-textSubtle">
              The type of token (color, font, spacing, border)
            </span>
          </div>
          <div className="flex gap-4">
            <span className="font-mono text-sm text-electric-pink w-24">
            ...
            <span className="text-sm text-textSubtle">
              What the token controls (background, text, size)
            </span>
          </div>
          <div className="flex gap-4">
            <span className="font-mono text-sm text-electric-pink w-24">
            ...
            <span className="text-sm text-textSubtle">
              A modifier or scale value (subtle, 100, small)
            </span>
          </div>
          <div className="flex gap-4">
            <span className="font-mono text-sm text-electric-pink w-24">
            ...
            <span className="text-sm text-textSubtle">
              Interactive state if applicable (hover, active, disabled)
            </span>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="font-mono text-xs">
              ...
              <tr className="border-b border-borderSubtle">
                <td className="py-3 px-4">--color-electric-pink-55</td>
                <td className="py-3 px-4 font-sans text-textSubtle">
                  color + electric-pink + 55 (lightness)
                </td>
              </tr>
              <tr>
                <td className="py-3 px-4">--spacing-4</td>
                <td className="py-3 px-4 font-sans text-textSubtle">
                  spacing + 4 (scale step)
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-success-bg-subtle border border-success-border rounded-lg p-4">
            ...
            <code className="text-xs font-mono">color: var(--color-textDefault);</code>
          </div>
