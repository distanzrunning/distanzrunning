...
import { ChoiceboxGroup, Choicebox } from "@/components/ui/Choicebox";
...
const singleSelectCode = `import { ChoiceboxGroup, Choicebox } from '@/components/ui/Choicebox';
...
const multiSelectCode = `import { ChoiceboxGroup, Choicebox } from '@/components/ui/Choicebox';
import { useState } from 'react';
...
const customContentCode = `import { ChoiceboxGroup, Choicebox } from '@/components/ui/Choicebox';
import { useState } from 'react';
...
export default function ChoiceboxComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="single-select" onCopyLink={showToast}>
          Single Select
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={singleSelectCode}>
            <SingleSelectDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="multi-select" onCopyLink={showToast}>
          Multi Select
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={multiSelectCode}>
            <MultiSelectDemo />
          </CodePreview>
        </div>
      </Section>
