...
const defaultCode = `import { CollapseGroup, Collapse } from '@/components/ui/Collapse';
...
const expandedCode = `import { CollapseGroup, Collapse } from '@/components/ui/Collapse';
...
const smallCode = `import { Collapse } from '@/components/ui/Collapse';
    ...
    <>
      ...
      <Section>
        ...
        <p className="text-copy-14 text-textSubtle mt-4 mb-4">
          Available props for the CollapseGroup component.
        </p>
        ...
        <p className="text-copy-14 text-textSubtle mb-6">
          Available props for the Collapse component.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody className="text-sm">
              ...
              <tr className="border-b border-borderSubtle">
                <td className="py-3 pr-4 font-mono">defaultExpanded</td>
                <td className="py-3 px-4 font-mono text-textSubtle">
                  boolean
                </td>
