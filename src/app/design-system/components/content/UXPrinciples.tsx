export default function UXPrinciples() {
  ...
  return (
    <div className="relative">
      ...
      <aside className="hidden xl:block fixed right-8 top-40 w-48">
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-textDefault">Contents</h4>
          <ol className="space-y-2">
            <li>
              <a
                href="#our-ux-principles"
                className="text-sm text-textSubtle hover:text-textDefault transition-colors"
              >
                Our UX principles
              </a>
