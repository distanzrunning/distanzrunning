...
function ColorSwatch({ name, value, category }: ColorSwatchProps) {
  ...
  return (
    ...
    >
      <div
        className="w-full h-32 rounded-lg shadow-sm border border-gray-300 mb-3 transition-shadow group-hover:shadow-md"
        style={{ backgroundColor: value }}
      />
      <div className="space-y-1">
        <p className="font-medium text-sm">{name}</p>
        <p className="text-xs text-gray-900 font-mono">{value}</p>
