    ...
    <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {shadowValues.map((shadow) => (
            <div key={shadow.name} className="group">
              <div
                className={`w-full h-32 rounded-lg ${shadow.class} mb-3 transition-transform hover:scale-105 border border-gray-400 flex items-center justify-center`}
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-900">{shadow.value}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-sm text-gray-900">
          <div>
            <p className="font-medium text-gray-1000 mb-2">Border Radius</p>
            <ul className="space-y-1 list-disc list-inside">
              <li>
                <strong className="text-gray-1000">rounded-md (6px):</strong>{" "}
                Default for buttons and form inputs
              </li>
              <li>
                <strong className="text-gray-1000">rounded-lg (8px):</strong>{" "}
                Cards and larger containers
              </li>
              <li>
                <strong className="text-gray-1000">rounded-xl (12px):</strong>{" "}
                Hero sections and feature cards
              </li>
              <li>
                <strong className="text-gray-1000">rounded-full:</strong>{" "}
                Badges, avatars, and pills
              </li>
            </ul>
          </div>
          <div>
            <p className="font-medium text-gray-1000 mb-2">Shadows</p>
            <ul className="space-y-1 list-disc list-inside">
              <li>
                <strong className="text-gray-1000">shadow-sm:</strong> Subtle
                cards and input fields
              </li>
              <li>
                <strong className="text-gray-1000">shadow-md:</strong> Dropdowns
                and popovers
              </li>
              <li>
                <strong className="text-gray-1000">shadow-lg:</strong> Modals
                and overlays
              </li>
              <li>
                <strong className="text-gray-1000">shadow-xl:</strong>{" "}
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <button className="px-6 py-3 bg-gray-1000 text-white dark:bg-white dark:text-gray-1000 rounded-md font-medium hover:opacity-90 transition-opacity">
              Primary Button
            </button>
            <pre className="mt-4 text-xs text-gray-900">rounded-md (6px)</pre>
          </div>
          ...
          >
            ...
            <div
              className="rounded-lg p-4 border border-gray-400 shadow-sm hover:shadow-md transition-shadow"
              style={{ background: "var(--ds-background-100)" }}
            >
            ...
            <pre className="mt-4 text-xs text-gray-900">
          ...
          >
            ...
            <span className="inline-block px-3 py-1 bg-gray-1000 text-white dark:bg-white dark:text-gray-1000 text-xs font-medium rounded-full">
              Marathon
            </span>
            <pre className="mt-4 text-xs text-gray-900">
              rounded-full (9999px)
          ...
          >
            ...
            <div
              className="rounded-xl p-6 border border-gray-400 shadow-2xl"
              style={{ background: "var(--ds-background-100)" }}
            >
              <p className="text-sm text-gray-900">
