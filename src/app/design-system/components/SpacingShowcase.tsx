...
function SpacingItem({ name, value, pixelValue }: SpacingItemProps) {
  return (
    <div className="flex items-center gap-6 py-4 border-b border-gray-300 last:border-b-0">
      <div className="w-24 flex-shrink-0">
        <p className="font-mono text-sm font-medium">{name}</p>
        <p className="text-xs text-gray-900">{value}</p>
        <p className="text-xs text-gray-600">{pixelValue}</p>
      </div>
      ...
      <div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="[background:var(--ds-background-100)] rounded-lg p-6 border border-gray-300">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="[background:var(--ds-background-100)] p-4 rounded border border-gray-300">
          ...
          >
            ...
            <div className="space-y-12">
              <div className="[background:var(--ds-background-100)] p-6 rounded border border-gray-300">
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-baseline gap-4 text-sm">
            ...
            <span className="text-gray-900">8px - Tight list items</span>
          </div>
          <div className="flex items-baseline gap-4 text-sm">
            <code className="font-mono text-neutral-700 dark:text-neutral-300 w-32">
              space-y-4
            </code>
            <span className="text-gray-900">16px - Standard paragraphs</span>
          </div>
          <div className="flex items-baseline gap-4 text-sm">
            <code className="font-mono text-neutral-700 dark:text-neutral-300 w-32">
              space-y-6
            </code>
            <span className="text-gray-900">24px - Form fields</span>
          </div>
          <div className="flex items-baseline gap-4 text-sm">
            <code className="font-mono text-neutral-700 dark:text-neutral-300 w-32">
              space-y-8
            </code>
            <span className="text-gray-900">32px - Card groups</span>
          </div>
          <div className="flex items-baseline gap-4 text-sm">
            <code className="font-mono text-neutral-700 dark:text-neutral-300 w-32">
              space-y-12
            </code>
            <span className="text-gray-900">48px - Major sections</span>
          </div>
          <div className="flex items-baseline gap-4 text-sm">
            <code className="font-mono text-neutral-700 dark:text-neutral-300 w-32">
              space-y-16
            </code>
            <span className="text-gray-900">64px - Page sections</span>
          </div>
        </div>
      </div>
    </div>
