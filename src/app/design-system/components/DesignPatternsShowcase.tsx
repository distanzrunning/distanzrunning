...
export default function DesignPatternsShowcase() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        <h3 className="font-serif text-xl font-medium mb-4">Common Design Patterns</h3>
        <p className="text-textSubtle">
          Reusable solutions to common design problems. These patterns ensure consistency across the Distanz Running platform and speed up development.
        </p>
      </div>

      {/* Navigation Patterns */}
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">Navigation Patterns</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Sticky header with logo, main nav, and action buttons</p>
            <div className="bg-canvas dark:bg-[#0a0a0a] border border-borderNeutral rounded-lg p-4">
  ...
  <div className="flex items-center justify-between">
    ...
    <CTAButton />
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Multi-column dropdown with images and organized content</p>
            <div className="bg-canvas dark:bg-[#0a0a0a] border border-borderNeutral rounded-lg p-6">
              <div className="grid grid-cols-3 gap-6">
                <div>
                  <p className="font-medium text-xs mb-3 text-electric-pink uppercase tracking-wide">Category 1</p>
                ...
                <div>
                  <p className="font-medium text-xs mb-3 text-electric-pink uppercase tracking-wide">Category 2</p>
                  <ul className="space-y-2 text-sm text-textSubtle">
                    <li>Item 1</li>
                    <li>Item 2</li>
                    <li>Item 3</li>
                ...
                <div className="bg-gradient-to-br from-electric-pink to-deep-purple rounded p-4 flex items-center justify-center">
                  <p className="text-white text-xs text-center">Featured Content</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <ol className="flex items-center gap-2">
    ...
    <li aria-current="page">Marathon Plans</li>
      ...
      {/* Content Patterns */}
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">Content Patterns</h3>

        <div className="space-y-6">
          {/* Article Card Grid */}
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            <h4 className="font-medium mb-4">Article Card Grid</h4>
            <p className="text-sm text-textSubtle mb-4">Responsive grid of article cards</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-canvas dark:bg-[#0a0a0a] rounded-lg overflow-hidden border border-borderNeutral hover:shadow-lg transition-shadow">
                  <div className="w-full h-32 bg-gradient-to-br from-electric-pink via-pace-purple to-deep-purple" />
                  <div className="p-4">
                    <p className="text-xs uppercase tracking-wide text-electric-pink font-medium mb-1">Category</p>
                    <p className="font-bold text-sm mb-1">Article Title {i}</p>
                    <p className="text-xs text-textSubtle">Brief description...</p>
                  </div>
                </div>
              ))}
            </div>
  ...
  {articles.map(article => (
    <ArticleCard key={article.id} {...article} />
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Large featured content with image and CTA</p>
    ...
    <div className="max-w-2xl px-6">
      ...
      <button>CTA</button>
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Switch between related content sections</p>
            <div className="border border-borderNeutral rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                {activeTab === 'overview' && <p className="text-sm text-textSubtle">Overview content...</p>}
                {activeTab === 'details' && <p className="text-sm text-textSubtle">Detailed information...</p>}
                {activeTab === 'specs' && <p className="text-sm text-textSubtle">Technical specifications...</p>}
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Real-time feedback on form inputs</p>
            <div className="max-w-md space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2">Email (Valid)</label>
                <input
                  type="email"
                  className="w-full px-4 py-3 border border-green-500 rounded-md bg-surface dark:bg-[#0c0c0d]"
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Email (Invalid)</label>
                <input
                  type="email"
                  className="w-full px-4 py-3 border border-red-500 rounded-md bg-surface dark:bg-[#0c0c0d]"
                  value="invalid-email"
                  readOnly
                />
      ...
      {/* Feedback Patterns */}
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">Feedback Patterns</h3>

        <div className="space-y-6">
          {/* Toast Notifications */}
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            <h4 className="font-medium mb-4">Toast Notifications</h4>
            <p className="text-sm text-textSubtle mb-4">Temporary feedback messages</p>
            <div className="space-y-3 max-w-md">
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-start gap-3">
                <span className="text-green-600">✓</span>
                <div className="flex-1">
                  <p className="text-sm font-medium text-green-900 dark:text-green-100">Success</p>
                  <p className="text-xs text-green-700 dark:text-green-200">Your changes have been saved</p>
                </div>
              </div>
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-red-700 dark:text-red-200">Something went wrong. Please try again</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Visual feedback during async operations</p>
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-sm text-textSubtle mb-4">Helpful messaging when no content exists</p>
            <div className="bg-canvas dark:bg-[#0a0a0a] rounded-lg p-12 text-center border border-borderNeutral">
      ...
      {/* Best Practices */}
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        <h3 className="font-serif text-xl font-medium mb-4">Pattern Implementation Best Practices</h3>
        <div className="space-y-3 text-sm text-textSubtle">
          <p><strong className="text-textDefault">Consistency:</strong> Use the same pattern for the same problem throughout the application.</p>
          <p><strong className="text-textDefault">Accessibility:</strong> Ensure all patterns are keyboard navigable and screen reader friendly.</p>
          <p><strong className="text-textDefault">Responsive:</strong> All patterns should adapt gracefully to mobile, tablet, and desktop.</p>
          <p><strong className="text-textDefault">Performance:</strong> Avoid heavy animations on pattern elements that appear frequently.</p>
          <p><strong className="text-textDefault">Documentation:</strong> Document pattern variations and when to use each one.</p>
        </div>
      </div>
    </div>
  );
