      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="[background:var(--ds-background-100)] border border-gray-400 rounded-lg p-4">
  ...
  <div className="flex items-center justify-between">
    ...
    <CTAButton />
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="[background:var(--ds-background-100)] border border-gray-400 rounded-lg p-6">
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-900">
              ...
              <span>/</span>
              <span className="text-gray-1000 font-medium">Marathon Plans</span>
            </nav>
            <pre className="mt-4 p-3 [background:var(--ds-background-100)] rounded text-xs overflow-x-auto">
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="[background:var(--ds-background-100)] rounded-lg overflow-hidden border border-gray-400 hover:shadow-lg transition-shadow"
                >
    ...
    <div className="max-w-2xl px-6">
      ...
      <button>CTA</button>
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="border border-gray-400 rounded-lg overflow-hidden">
              <div className="flex border-b border-gray-400 [background:var(--ds-gray-100)]">
                <button
              ...
              <div className="p-6">
                {activeTab === "overview" && (
                  <p className="text-sm text-gray-900">Overview content...</p>
                )}
                {activeTab === "details" && (
        ...
        <div className="space-y-6">
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="max-w-md space-y-4">
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-4 py-3 border border-green-500 rounded-md [background:var(--ds-gray-100)]"
              ...
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-4 py-3 border border-red-500 rounded-md [background:var(--ds-gray-100)]"
                  value="invalid-email"
                  readOnly
                />
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="flex items-center justify-between max-w-md">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full [background:var(--ds-gray-100)] border border-gray-400 text-gray-900 flex items-center justify-center text-sm font-medium mb-2">
                  3
                </div>
                <p className="text-xs text-gray-900">Confirm</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-2">
                  <div className="h-4 [background:var(--ds-gray-100)] rounded animate-pulse" />
                  <div className="h-4 [background:var(--ds-gray-100)] rounded animate-pulse w-3/4" />
                  <div className="h-4 [background:var(--ds-gray-100)] rounded animate-pulse w-1/2" />
                </div>
              </div>
              <div>
                <p className="text-xs font-medium mb-2">Spinner</p>
                <div className="w-8 h-8 border-4 border-gray-400 border-t-electric-pink rounded-full animate-spin" />
              </div>
            </div>
          </div>
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="[background:var(--ds-background-100)] rounded-lg p-12 text-center border border-gray-400">
      ...
      <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
        ...
        <div className="space-y-3 text-sm text-gray-900">
          <p>
            <strong className="text-gray-1000">Consistency:</strong> Use the
            same pattern for the same problem throughout the application.
          </p>
          <p>
            <strong className="text-gray-1000">Accessibility:</strong> Ensure
            all patterns are keyboard navigable and screen reader friendly.
          </p>
          <p>
            <strong className="text-gray-1000">Responsive:</strong> All patterns
            should adapt gracefully to mobile, tablet, and desktop.
          </p>
          <p>
            <strong className="text-gray-1000">Performance:</strong> Avoid heavy
            animations on pattern elements that appear frequently.
          </p>
          <p>
            <strong className="text-gray-1000">Documentation:</strong> Document
            pattern variations and when to use each one.
          </p>
        </div>
      </div>
    </div>
