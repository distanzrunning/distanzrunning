  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        <h3 className="font-serif text-xl font-medium mb-4">Accessibility First</h3>
        <p className="text-textSubtle mb-4">
          Distanz Running is committed to creating an inclusive experience for all users. We follow WCAG 2.1 Level AA standards and prioritize semantic HTML, keyboard navigation, and screen reader support.
        </p>
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="bg-surface dark:bg-[#0c0c0d] rounded p-4">
            <p className="font-medium text-textDefault mb-1">Perceivable</p>
            <p className="text-textSubtle text-xs">Information must be presentable to users in ways they can perceive</p>
          </div>
          <div className="bg-surface dark:bg-[#0c0c0d] rounded p-4">
            <p className="font-medium text-textDefault mb-1">Operable</p>
            <p className="text-textSubtle text-xs">Interface components must be operable by all users</p>
          </div>
          <div className="bg-surface dark:bg-[#0c0c0d] rounded p-4">
            <p className="font-medium text-textDefault mb-1">Understandable</p>
            <p className="text-textSubtle text-xs">Information and operation must be understandable</p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <p className="text-textSubtle mb-6">All text meets WCAG AA contrast requirements (4.5:1 for normal text, 3:1 for large text).</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-neutral-950 rounded-lg p-6 border border-borderNeutral">
                <p className="text-textDefault text-base mb-2">Default Text on Canvas</p>
                <p className="text-xs text-textSubtle font-mono">Ratio: 19.5:1 (Light) / 18.2:1 (Dark)</p>
              </div>
              <div className="bg-white dark:bg-neutral-950 rounded-lg p-6 border border-borderNeutral">
                <p className="text-textSubtle text-base mb-2">Subtle Text on Canvas</p>
                <p className="text-xs text-textSubtle font-mono">Ratio: 7.1:1 (Light) / 4.9:1 (Dark)</p>
              </div>
              <div className="bg-electric-pink rounded-lg p-6">
                <p className="text-white text-base mb-2">White on Electric Pink</p>
                <p className="text-xs text-white/80 font-mono">Ratio: 5.8:1</p>
              </div>
              <div className="bg-volt-green rounded-lg p-6">
                <p className="text-neutral-900 text-base mb-2">Dark on Volt Green</p>
                <p className="text-xs text-neutral-900/80 font-mono">Ratio: 14.2:1</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <p className="text-sm font-medium mb-3 flex items-center gap-2">
              <span className="text-red-600">✗</span> Avoid: Poor Contrast Ratios
            </p>
            <div className="grid md:grid-cols-2 gap-4 opacity-50">
              <div className="bg-white dark:bg-neutral-950 rounded-lg p-6 border border-red-200 dark:border-red-800">
                <p className="text-neutral-300 text-base mb-2">Light Gray on White (Bad)</p>
                <p className="text-xs text-red-600 font-mono">Ratio: 2.1:1 - Fails WCAG AA</p>
              </div>
              <div className="bg-electric-pink rounded-lg p-6 border border-red-200 dark:border-red-800">
                <p className="text-deep-purple text-base mb-2">Purple on Pink (Bad)</p>
                <p className="text-xs text-neutral-900 font-mono">Ratio: 1.8:1 - Fails WCAG AA</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <p className="text-textSubtle mb-6">Proper HTML semantics provide structure and meaning for assistive technologies.</p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-sm mb-2">Use Semantic Elements</p>
...
<footer>
  <p>&copy; 2026 Distanz Running</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <pre className="p-3 bg-canvas dark:bg-[#0a0a0a] rounded text-xs overflow-x-auto opacity-50">
  ...
  <div class="nav">
    <div class="nav-item">Home</div>
      ...
      {/* Keyboard Navigation */}
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">Keyboard Navigation</h3>
        <p className="text-textSubtle mb-6">All interactive elements must be keyboard accessible with visible focus states.</p>
  ...
  Button
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <p className="text-xs text-textSubtle mb-3">Press Tab on page load to reveal skip navigation link</p>
            <pre className="p-3 bg-canvas dark:bg-[#0a0a0a] rounded text-xs overflow-x-auto">
              <code>{`<a
  href="#main-content"
...
>
  Skip to main content
          ...
          <div className="bg-surface dark:bg-[#0c0c0d] rounded-lg p-6 border border-borderNeutral">
            ...
            <div className="space-y-2 text-xs text-textSubtle">
              <p>• Logical flow: top to bottom, left to right</p>
              <p>• Avoid positive tabindex values</p>
              <p>• Use tabindex="-1" for elements that should not be in tab order</p>
              <p>• Use tabindex="0" to add non-interactive elements to tab order</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* ARIA Labels */}
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">ARIA Labels & Landmarks</h3>
        <p className="text-textSubtle mb-6">Use ARIA attributes to provide additional context for assistive technologies.</p>
...
/>
<p id="email-hint" className="text-sm text-textSubtle">
  We'll never share your email
      ...
      <div>
        <h3 className="font-serif text-2xl font-medium mb-4">Screen Reader Support</h3>
        <p className="text-textSubtle mb-6">Optimize content for screen reader users.</p>
