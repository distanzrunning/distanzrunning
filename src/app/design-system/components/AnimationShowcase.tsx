...
export default function AnimationShowcase() {
    ...
    <div className="space-y-12">
      ...
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        ...
        <div className="space-y-2 text-sm text-textSubtle">
          <p>
            <strong className="text-textDefault">Speed:</strong> Quick
            interactions (100-200ms), moderate transitions (300ms), complex
            animations (500ms+)
          </p>
          <p>
            <strong className="text-textDefault">Easing:</strong> ease-out for
            entering, ease-in for exiting, ease-in-out for movement
          </p>
          <p>
            <strong className="text-textDefault">Purpose:</strong> Guide
  ...
  Hover Me
          ...
          <div className="bg-surface rounded-lg p-6 border border-borderNeutral">
            ...
            <div className="bg-canvas rounded-lg p-6 border border-borderNeutral shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300 inline-block">
          ...
          <div className="bg-surface rounded-lg p-6 border border-borderNeutral">
            ...
            <div className="border border-borderNeutral rounded-lg overflow-hidden">
              <button
                ...
                className="w-full px-4 py-3 bg-canvas text-left font-medium flex items-center justify-between hover:bg-surface-subtle transition-colors"
              >
              ...
              >
                <div className="p-4 bg-surface border-t border-borderNeutral">
  ...
  Content
      ...
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        ...
        <pre className="p-4 bg-canvas rounded text-xs overflow-x-auto">
    ...
    <motion.div variants={itemVariants} key={item.id}>
      ...
      <div className="bg-surface-subtle rounded-lg p-6 border border-borderNeutral">
        ...
        <div className="space-y-3 text-sm text-textSubtle">
          ...
          <p>
            <strong className="text-textDefault">No Seizure Risk:</strong> Avoid
            flashing or rapid color changes that could trigger seizures.
          </p>
          <p>
            <strong className="text-textDefault">Essential Info:</strong> Never
            rely solely on animation to convey critical information.
          </p>
          <p>
            <strong className="text-textDefault">Pausable:</strong> Long-running
            animations should be pausable by the user.
          </p>
        </div>
        <pre className="mt-4 p-4 bg-canvas rounded text-xs overflow-x-auto">
