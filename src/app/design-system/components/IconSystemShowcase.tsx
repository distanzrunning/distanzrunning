      ...
      <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
        ...
        <p className="text-gray-900 mb-4">
          ...
          <a
            ...
            className="text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white hover:underline"
          >
            Lucide React
          </a>{" "}
          (v0.503.0) for all iconography. Lucide provides a consistent, modern
  ...
  Create Article
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              <button
                className="w-10 h-10 flex items-center justify-center bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-md hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors"
                aria-label="Search"
              >
  ...
  <span>Success message</span>
          ...
          <div className="[background:var(--ds-gray-100)] rounded-lg p-6 border border-gray-400">
            ...
            <div className="flex items-center gap-4 mb-4">
              <button
                className="px-4 py-2 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-md font-medium flex items-center gap-2"
                disabled
              >
        ...
        <div className="space-y-4 text-sm text-gray-900">
          <div>
            ...
            <ul className="space-y-1 list-disc list-inside ml-4">
              ...
              <li>
                Use semantic color for status icons (green for success, red for
                error)
              </li>
              <li>
                Align icon size with adjacent text (w-4 h-4 for small text, w-5
                h-5 for body text)
              </li>
          ...
          <div>
            ...
            <ul className="space-y-1 list-disc list-inside ml-4">
              ...
              <li>
                Use overly decorative icons that don't serve a functional
                purpose
              </li>
              <li>
                Make icons too small (below 16px) as they become hard to
                recognize
              </li>
