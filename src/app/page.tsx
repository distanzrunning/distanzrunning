                        ...
                        <div className="flex flex-row items-start py-4 px-2.5 lg:gap-3 lg:pl-1.5 lg:pt-4 lg:pb-4 lg:pr-5">
                          ...
                          <div className="flex-1 flex flex-col lg:px-2.5" style={{ width: '67%' }}>
                            ...
                            <Link href={
                              ...
                              <h3 className="text-base lg:text-[22px] leading-[1.66] lg:leading-[1.2] font-bold text-neutral-900 dark:text-white line-clamp-3 lg:line-clamp-3 hover:underline hover:decoration-electric-pink hover:decoration-1 hover:underline-offset-2 mb-2 lg:mb-1">
                                {post.title}
                              </h3>
                            </Link>

                            {/* Date and Read Time */}
                            <div className="flex flex-col lg:flex-row lg:items-center gap-1 lg:gap-2 text-sm lg:text-[11px] text-neutral-500 dark:text-neutral-400">
                              <span suppressHydrationWarning>
                                {format(new Date(post.publishedAt), 'd MMM yyyy')}
                              </span>
                              <span className="lg:hidden">{post.readingTime || 5} min read</span>
                          ...
                          <Link
                            ...
                            className="shrink-0 overflow-hidden transition-opacity duration-200 hover:opacity-80 ml-2.5"
                            style={{ width: '33%' }}
                          >
