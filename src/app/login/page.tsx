  ...
  return (
    <DarkModeProvider>
      <div className="min-h-screen bg-white dark:bg-[#0c0c0d] transition-colors duration-300 flex items-center justify-center p-4">
        {/* Login container */}
        <div className="w-full max-w-sm bg-neutralBgSubtle rounded-xl p-8 shadow-sm transition-colors duration-300">
              ...
              <div>
                ...
                <div className="relative flex border border-borderNeutral rounded-lg hover:border-borderNeutralHover focus-within:ring-2 focus-within:ring-borderNeutral focus-within:border-borderNeutralHover transition-colors duration-300 overflow-hidden">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-11 border-l border-borderNeutral bg-asphalt-95 dark:bg-asphalt-20 text-asphalt-40 dark:text-asphalt-60 hover:text-asphalt-20 dark:hover:text-asphalt-80 transition-colors"
                    aria-label={
