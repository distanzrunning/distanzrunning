...
export function Component(): JSX.Element {
  return (
    <div className="flex h-8 items-center space-x-4">
      <p className="text-copy-14 text-textDefault">Home</p>
      <Separator orientation="vertical" />
      <p className="text-copy-14 text-textDefault">About</p>
      <Separator orientation="vertical" />
      <p className="text-copy-14 text-textDefault">Services</p>
      <Separator orientation="vertical" />
      <p className="text-copy-14 text-textDefault">Contact</p>
    </div>
  )
}`;

const orientationCode = `import type { JSX } from 'react'
import { Separator } from '@/components/ui/Separator'
...
const accessibilityCode = `import type { JSX } from 'react'
import { Separator } from '@/components/ui/Separator'
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-copy-14 text-textSubtle">This separator is purely visual</p>
        <Separator />
        <p className="text-copy-14 text-textSubtle">Content continues below</p>
      </div>
      <div>
        <h4 className="mb-2 text-label-14">Semantic Separator</h4>
        <p className="text-copy-14 text-textSubtle">This separator has semantic meaning</p>
        <Separator decorative={false} />
        <p className="text-copy-14 text-textSubtle">Distinctly separate content section</p>
      </div>
    </div>
  )
}`;

const customStylingCode = `import type { JSX } from 'react'
import { Separator } from '@/components/ui/Separator'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <Separator className="bg-[var(--ds-blue-700)]" />
      </div>
      <div>
      ...
      <div>
        ...
        <div className="flex h-8 items-center space-x-4">
          ...
          <Separator orientation="vertical" className="bg-[var(--ds-red-700)] w-0.5" />
          <span className="text-copy-14">Item 2</span>
          <Separator orientation="vertical" className="bg-[var(--ds-green-700)] w-2" />
        </div>
      </div>
    </div>
  )
...
export default function SeparatorComponent() {
  ...
  return (
    <>
      <Section>
        <SectionHeader id="horizontal" onCopyLink={showToast}>
          Horizontal
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={horizontalCode}>
            <HorizontalDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="vertical" onCopyLink={showToast}>
          Vertical
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={verticalCode}>
            <VerticalDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="orientation-variants" onCopyLink={showToast}>
          Orientation Variants
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={orientationCode}>
            <OrientationDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="accessibility-variants" onCopyLink={showToast}>
          Accessibility Variants
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={accessibilityCode}>
            <AccessibilityDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="custom-styling" onCopyLink={showToast}>
          Custom Styling
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={customStylingCode}>
            <CustomStylingDemo />
          </CodePreview>
        </div>
      </Section>
