...
const defaultCode = `import { ErrorCard } from '@/components/ui/ErrorCard';

export function Component() {
  return <ErrorCard title="No credits left" />;
}`;

export default function ErrorCardComponent() {
      ...
      <Section>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultCode}>
            <ErrorCard title="No credits left" />
          </CodePreview>
        </div>
      </Section>
    </>
