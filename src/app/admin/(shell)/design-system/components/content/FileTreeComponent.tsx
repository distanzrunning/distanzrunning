...
function RenderShikiToken({ token }: { token: DualThemeToken }) {
  return <span style={getTokenStyle(token)}>{token.content}</span>;
}
...
const defaultCode = `import { FileTree } from '@/components/ui/FileTree';
      ...
      <FileTree.Folder name=".vercel" defaultOpen>
        <FileTree.Folder name="output" defaultOpen>
          <FileTree.Folder name="functions" defaultOpen>
            <FileTree.Folder name="edge.func" defaultOpen>
              <FileTree.File name=".vc-config.json" href="/" />
