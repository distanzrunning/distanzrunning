  ...
  return (
    <div className="flex flex-col gap-2">
      <ClearableInput
        ...
        value={value}
        onChange={setValue}
        onClear={() => setCount((c) => c + 1)}
        className="w-full"
      />
      <p className="text-copy-14 text-textSubtle">Cleared {count} times</p>
    </div>
  );
}
...
const defaultCode = `import { ClearableInput } from '@/components/ui/ClearableInput';
...
const withLabelCode = `import { ClearableInput } from '@/components/ui/ClearableInput';
...
const withCmdkCode = `import { ClearableInput } from '@/components/ui/ClearableInput';

export function Component() {
  // Shows ⌘K while empty, then the Esc clear hint once there's text.
  return (
    <ClearableInput cmdk aria-label="Search with cmdk" placeholder="Search..." />
  );
}`;

const disabledCode = `import { ClearableInput } from '@/components/ui/ClearableInput';
...
const clearCallbackCode = `import { useState } from 'react';
import { ClearableInput } from '@/components/ui/ClearableInput';
  ...
  return (
    <div className="flex flex-col gap-2">
      <ClearableInput
        ...
        placeholder="Enter some text and clear..."
      />
      <p>Cleared {count} times</p>
    </div>
  );
}`;

export default function ClearableInputComponent() {
