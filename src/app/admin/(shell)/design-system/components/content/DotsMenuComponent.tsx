...
function CodePreview({ children, componentCode }: CodePreviewProps) {
  ...
  return (
    <div className="border border-borderDefault rounded-lg">
      <div className="p-6 rounded-t-lg" style={{ background: "hsl(var(--color-surface))" }}>
        {children}
      </div>
      <div className="rounded-b-lg overflow-hidden" style={{ background: "hsl(var(--color-canvas))" }}>
        <button
          type="button"
...
function MenuItems() {
  return (
    <>
      <DotsMenu.Item onClick={() => {}}>Edit</DotsMenu.Item>
      <DotsMenu.Item onClick={() => {}}>Duplicate</DotsMenu.Item>
      <DotsMenu.Item onClick={() => {}}>Archive</DotsMenu.Item>
      <DotsMenu.Separator />
      <DotsMenu.Item destructive onClick={() => {}}>
        Delete
      </DotsMenu.Item>
    </>
  );
...
function DisabledItemDemo() {
  return (
    <DotsMenu>
      <DotsMenu.Item onClick={() => {}}>Edit</DotsMenu.Item>
      <DotsMenu.Item disabled>Duplicate</DotsMenu.Item>
      <DotsMenu.Item onClick={() => {}}>Archive</DotsMenu.Item>
      <DotsMenu.Separator />
      <DotsMenu.Item destructive onClick={() => {}}>
        Delete
...
const defaultCode = `import { DotsMenu } from '@/components/ui/DotsMenu';
...
function Demo() {
  return (
    <DotsMenu>
      ...
      <DotsMenu.Item onClick={() => {}}>Archive</DotsMenu.Item>
      <DotsMenu.Separator />
      <DotsMenu.Item destructive onClick={() => {}}>Delete</DotsMenu.Item>
    </DotsMenu>
  );
}`;

const sizesCode = `import { DotsMenu } from '@/components/ui/DotsMenu';

function Demo() {
  return (
    <div className="flex items-start gap-6">
      <DotsMenu size="small">{/* items */}</DotsMenu>
      <DotsMenu size="medium">{/* items */}</DotsMenu>
      <DotsMenu size="large">{/* items */}</DotsMenu>
    </div>
  );
}`;

const disabledCode = `import { DotsMenu } from '@/components/ui/DotsMenu';
...
const disabledItemCode = `import { DotsMenu } from '@/components/ui/DotsMenu';
...
export default function DotsMenuComponent() {
  ...
  return (
    <>
      ...
      {/* Disabled Menu Item */}
      <Section>
        <SectionHeader id="disabled-menu-item" onCopyLink={showToast}>
          Disabled Menu Item
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={disabledItemCode}>
            <DisabledItemDemo />
          </CodePreview>
        </div>
      </Section>
