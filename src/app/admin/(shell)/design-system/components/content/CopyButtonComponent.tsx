...
const defaultCode = `import { CopyButton } from '@/components/ui/CopyButton';

function Demo() {
  return <CopyButton value="https://distanzrunning.com" />;
}`;
      ...
      <Section>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultCode}>
            <CopyButton value="https://distanzrunning.com" />
          </CodePreview>
        </div>
      </Section>
    </>
