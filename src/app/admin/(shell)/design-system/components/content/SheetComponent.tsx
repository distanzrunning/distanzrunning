  ...
  return (
    <div className="flex flex-col text-center">
      <h2
        ...
        style={{ fontSize: 18, lineHeight: "28px", color: "rgb(var(--color-textDefault))" }}
      >
        Sheet from {side}
      </h2>
      <p style={{ fontSize: 14, lineHeight: "20px", color: "rgb(var(--color-textSubtler))" }}>
        This sheet slides in from the {side}.
      </p>
    </div>
  );
...
export default function SheetComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="with-side" onCopyLink={showToast}>
          With Side
        </SectionHeader>
        <p
          className="mt-2 leading-6 xl:mt-4"
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={withSideCode}>
            <WithSideDemo />
          </CodePreview>
        </div>
      </Section>
