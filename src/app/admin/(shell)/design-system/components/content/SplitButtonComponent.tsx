  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-row gap-4 items-center">
        <SplitButton size="small" menuItems={menuItems}>
          Save
        </SplitButton>
        <SplitButton size="medium" menuItems={menuItems}>
          Save
        </SplitButton>
        <SplitButton size="large" menuItems={menuItems}>
          Save
        </SplitButton>
      </div>
      <div className="flex flex-row gap-4 items-center">
        <SplitButton variant="secondary" size="small" menuItems={menuItems}>
          Save
        </SplitButton>
        <SplitButton variant="secondary" size="medium" menuItems={menuItems}>
          Save
        </SplitButton>
        <SplitButton variant="secondary" size="large" menuItems={menuItems}>
          Save
        </SplitButton>
      </div>
    </div>
...
function IconDemo() {
  return (
    <SplitButton
      ...
      size="small"
      menuItems={[
        { label: "Copy link", description: "Copy the page URL", icon: <MenuLinkIcon />, onClick: () => {} },
        { label: "Copy page", description: "Copy page content", icon: <MenuCopyIcon />, onClick: () => {} },
      ]}
    >
      Copy page
    </SplitButton>
...
export default function SplitButtonComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="menu-alignment" onCopyLink={showToast}>
          Menu Alignment
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={menuAlignmentCode}>
            <MenuAlignmentDemo />
          </CodePreview>
        </div>
      </Section>
