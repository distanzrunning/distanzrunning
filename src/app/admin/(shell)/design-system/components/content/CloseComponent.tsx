    ...
    <article className="space-y-10">
      ...
      <header>
        ...
        <p className="text-lg text-textSubtle max-w-2xl">
          A close control for dismissing modals, dialogs, drawers, and other overlay elements.
          Uses the IconButton component with an X icon for consistent styling.
        </p>
      </header>
        ...
        <div className="mb-4">
          <label className="inline-flex items-center gap-2 text-sm text-textSubtle cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-borderNeutral"
            />
            Disabled
          </label>
        </div>
  ...
  <X className="w-5 h-5" />
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-borderNeutral">
                <th className="text-left py-3 pr-4 font-medium text-textDefault">Prop</th>
                <th className="text-left py-3 pr-4 font-medium text-textDefault">Type</th>
                <th className="text-left py-3 pr-4 font-medium text-textDefault">Default</th>
                <th className="text-left py-3 font-medium text-textDefault">Description</th>
              </tr>
            </thead>
      ...
      <section>
        ...
        <div className="space-y-4 text-textSubtle">
          ...
          <div>
            <h3 className="font-medium text-textDefault mb-2">Placement</h3>
            <ul className="list-disc list-inside space-y-1">
              <li>Position close buttons in the top-right corner of modals and dialogs</li>
              <li>Ensure adequate touch target size (minimum 40×40px on mobile)</li>
              <li>Maintain consistent positioning across all dismissible overlays</li>
            </ul>
          </div>
          <div>
            <h3 className="font-medium text-textDefault mb-2">When to use inverse</h3>
            <ul className="list-disc list-inside space-y-1">
              <li>Use the inverse variant when the close button appears on dark backgrounds</li>
              <li>This is common in full-screen overlays, dark-themed modals, or image lightboxes</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <h3 className="font-medium text-textDefault">Modal Header</h3>
          <div className="border border-borderNeutral rounded-lg overflow-hidden">
            <div className="bg-white p-4 flex items-center justify-between border-b border-borderNeutral">
              <h4 className="font-medium text-textDefault">Modal Title</h4>
