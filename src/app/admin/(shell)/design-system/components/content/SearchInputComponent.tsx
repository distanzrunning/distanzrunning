...
const defaultCode = `import { SearchInput } from '@/components/ui/SearchInput';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return <SearchInput placeholder="Enter some text..." />;
}`;

const cmdkCode = `import { SearchInput } from '@/components/ui/SearchInput';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return <SearchInput cmdk placeholder="Enter some text..." />;
}`;

const disabledCode = `import { SearchInput } from '@/components/ui/SearchInput';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return <SearchInput cmdk disabled placeholder="Enter some text..." />;
}`;

const loadingCode = `import { SearchInput } from '@/components/ui/SearchInput';
import { Kbd } from '@/components/ui/Kbd';
import type { JSX } from 'react';
...
export function Component(): JSX.Element {
  return (
    <SearchInput
      ...
      suffix={<Kbd size="small">Esc</Kbd>}
    />
  );
}`;

const customPrefixCode = `import { SearchInput } from '@/components/ui/SearchInput';
import { SparkleIcon } from './icons';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return <SearchInput prefix={<SparkleIcon />} placeholder="Enter some text..." />;
}`;
  ...
  return (
    <>
      ...
      <Section>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={cmdkCode}>
            <SearchInput cmdk />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="custom-prefix" onCopyLink={showToast}>
          Custom Prefix
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={customPrefixCode}>
            <SearchInput prefix={<SparkleIcon />} />
          </CodePreview>
        </div>
      </Section>
