...
const defaultCode = `import { Video } from '@/components/ui/Video';
...
export default function VideoComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="no-loop" onCopyLink={showToast}>
          No Loop
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={noLoopCode}>
            <NoLoopDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="no-controls" onCopyLink={showToast}>
          No Controls
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={noControlsCode}>
            <NoControlsDemo />
          </CodePreview>
        </div>
      </Section>
