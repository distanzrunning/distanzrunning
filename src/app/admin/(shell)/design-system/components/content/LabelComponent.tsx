...
const bypassCasingCode = `import { Label } from '@/components/ui/Label';
import { Input } from '@/components/ui/Input';
import type { JSX } from 'react';
...
export function Component(): JSX.Element {
  return (
    <>
      <Label htmlFor="email" capitalize={false}>
        Email address
      </Label>
      <Input id="email" placeholder="Enter email address..." />
    </>
...
function DefaultDemo() {
  return <Label htmlFor="label-default">This is a label</Label>;
}
...
function WithInputDemo() {
  return (
    <div>
      ...
      <Input id="label-with-input" placeholder="Enter email address..." />
    </div>
  );
}

function BypassCasingDemo() {
  return (
    <div>
      <Label htmlFor="label-bypass" capitalize={false}>
        Email address
      </Label>
      <Input id="label-bypass" placeholder="Enter email address..." />
    </div>
  );
}
