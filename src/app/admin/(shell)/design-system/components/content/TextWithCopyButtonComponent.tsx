...
const defaultCode = `import { TextWithCopyButton } from '@/components/ui/TextWithCopyButton';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return (
    <TextWithCopyButton text="Copy" toastMessage="Copied to clipboard" />
  );
}`;

const smallTertiaryCode = `import { TextWithCopyButton } from '@/components/ui/TextWithCopyButton';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return (
    <TextWithCopyButton
      text="Copy config digest"
      copyValue="sha256:6b3e…a91f"
...
function DefaultDemo() {
  return <TextWithCopyButton text="Copy" toastMessage="Copied to clipboard" />;
}

function SmallTertiaryDemo() {
  return (
    <TextWithCopyButton
      text="Copy config digest"
      copyValue="sha256:6b3e…a91f"
...
export default function TextWithCopyButtonComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="with-small-and-tertiary" onCopyLink={showToast}>
          With Small and Tertiary
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={smallTertiaryCode}>
            <SmallTertiaryDemo />
          </CodePreview>
        </div>
      </Section>
