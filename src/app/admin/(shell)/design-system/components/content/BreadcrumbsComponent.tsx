...
export function Component() {
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Menu variant */}
      <Breadcrumbs items={items} variant="menu" />
    </div>
  );
}`;

const activeCode = `import { Breadcrumbs } from '@/components/ui/Breadcrumbs';
...
const disabledCode = `import { Breadcrumbs } from '@/components/ui/Breadcrumbs';
    ...
    <>
        ...
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultCode}>
            <div className="flex flex-col gap-4">
              ...
              <Breadcrumbs items={baseItems} variant="menu" />
            </div>
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        ...
        <ul className="mt-4 list-disc pl-6 space-y-2 text-copy-16 text-textSubtle">
          <li>
            Use breadcrumbs on pages nested two or more levels deep so users
            can see where they are and jump back up the hierarchy.
          </li>
          <li>
            Reach for the <code className="inline-code">text</code> variant
            inline above a page title; use the{" "}
            <code className="inline-code">menu</code> variant when crumbs sit
            in a tight bar and may need to truncate.
          </li>
          <li>
            Don&apos;t use breadcrumbs as the primary navigation, and
            don&apos;t mirror a single-level path — they earn their place only
            when there&apos;s a real hierarchy to retrace.
          </li>
        </ul>
        ...
        <ul className="mt-4 list-disc pl-6 space-y-2 text-copy-16 text-textSubtle">
          <li>
            Label each crumb with the destination&apos;s real page title in
            Title Case; keep them short so the trail stays on one line.
          </li>
          <li>
            Order crumbs root-first and make every crumb except the current
            page a working link.
          </li>
          <li>
            Mark the current page with{" "}
            <code className="inline-code">active</code> rather than dropping it
            — the trail should always show the full path.
          </li>
        </ul>
        ...
        <ul className="mt-4 list-disc pl-6 space-y-2 text-copy-16 text-textSubtle">
          <li>
            The trail is wrapped in a{" "}
            <code className="inline-code">
              &lt;nav aria-label=&quot;Breadcrumb&quot;&gt;
            </code>{" "}
            with an ordered list, so assistive tech announces it as a single
            landmark.
          </li>
          <li>
            The current page carries{" "}
            <code className="inline-code">aria-current=&quot;page&quot;</code>;
            separators are{" "}
            <code className="inline-code">aria-hidden</code> so they aren&apos;t
            read aloud.
          </li>
          <li>
            Crumb links take the blue focus ring on keyboard focus; disabled
            crumbs are not focusable.
          </li>
        </ul>
      </Section>
    </>
