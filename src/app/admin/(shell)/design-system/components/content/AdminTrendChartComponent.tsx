...
export default function AdminTrendChartComponent() {
      ...
      <Section>
        ...
        <ul className="mt-4 list-disc pl-6 space-y-2 text-copy-16 text-textSubtle">
          <li>
            ...
            Pair with <ComponentRef name="Admin Date Range Picker" /> and{" "}
            <ComponentRef name="Admin Env Filter" /> on the row above.
          </li>
          <li>
