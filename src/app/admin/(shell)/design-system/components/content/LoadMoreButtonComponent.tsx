...
const defaultCode = `import { LoadMoreButton } from '@/components/ui/LoadMoreButton';
...
const loadingCode = `import { LoadMoreButton } from '@/components/ui/LoadMoreButton';
import type { JSX } from 'react';
...
const noGapCode = `import { LoadMoreButton } from '@/components/ui/LoadMoreButton';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return (
    <LoadMoreButton gap={false} onClick={() => {}} />
  );
}`;

const noRadiusCode = `import { LoadMoreButton } from '@/components/ui/LoadMoreButton';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return (
    <LoadMoreButton rounded={false} onClick={() => {}} />
  );
}`;

const customTextCode = `import { LoadMoreButton } from '@/components/ui/LoadMoreButton';
import type { JSX } from 'react';

export function Component(): JSX.Element {
  return (
    <LoadMoreButton onClick={() => {}}>Show More Results</LoadMoreButton>
  );
}`;
...
export default function LoadMoreButtonComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="no-gap" onCopyLink={showToast}>
          No Gap
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={noGapCode}>
            <LoadMoreButton gap={false} onClick={() => {}} />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="no-border-radius" onCopyLink={showToast}>
          No Border Radius
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={noRadiusCode}>
            <LoadMoreButton rounded={false} onClick={() => {}} />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="custom-text" onCopyLink={showToast}>
          Custom Text
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={customTextCode}>
            <LoadMoreButton onClick={() => {}}>Show More Results</LoadMoreButton>
          </CodePreview>
        </div>
      </Section>
