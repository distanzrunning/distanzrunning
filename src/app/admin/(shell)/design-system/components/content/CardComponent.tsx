...
export function Component() {
  return (
    <Card>
      <p className="text-copy-14 text-textSubtle">A simple card</p>
    </Card>
  );
}`;

const hoverCode = `import { Card } from '@/components/ui/Card';
...
const borderCode = `import { Card } from '@/components/ui/Card';
...
const borderBetweenCode = `import { Card } from '@/components/ui/Card';

export function Component() {
  return (
    <Card variant="border" borderBetween>
      <p className="text-copy-14 text-textSubtle py-2">Option 1</p>
      <p className="text-copy-14 text-textSubtle py-2">Option 2</p>
      <p className="text-copy-14 text-textSubtle py-2">Option 3</p>
    </Card>
  );
}`;

const borderBetweenVerticalCode = `import { Card } from '@/components/ui/Card';

export function Component() {
  return (
    <Card variant="border" borderBetween row>
      <p className="text-copy-14 text-textSubtle px-2 w-full">Option 1</p>
      <p className="text-copy-14 text-textSubtle px-2 w-full">Option 2</p>
      <p className="text-copy-14 text-textSubtle px-2 w-full">Option 3</p>
    </Card>
  );
}`;

const secondaryCode = `import { Card } from '@/components/ui/Card';

export function Component() {
  return (
    <Card variant="secondary" borderBetween>
      <p className="text-copy-14 text-textSubtle py-2">Option 1</p>
      <p className="text-copy-14 text-textSubtle py-2">Option 2</p>
      <p className="text-copy-14 text-textSubtle py-2">Option 3</p>
    </Card>
  ...
  return (
    <>
      ...
      <Section>
        ...
        <CodePreview componentCode={hoverCode}>
          <Card variant="hover">
            <p className="text-copy-14 text-textSubtle">A simple card</p>
          </Card>
        </CodePreview>
      ...
      {/* Border */}
      <Section>
        <SectionHeader id="border" onCopyLink={showToast}>
          Border
        </SectionHeader>
        <CodePreview componentCode={borderCode}>
          <Card variant="border">
            <p className="text-copy-14 text-textSubtle">A simple card</p>
          </Card>
        </CodePreview>
      ...
      {/* Border Between */}
      <Section>
        <SectionHeader id="border-between" onCopyLink={showToast}>
          Border Between
        </SectionHeader>
        <CodePreview componentCode={borderBetweenCode}>
          <Card variant="border" borderBetween>
            <p className="text-copy-14 text-textSubtle py-2">Option 1</p>
            <p className="text-copy-14 text-textSubtle py-2">Option 2</p>
            <p className="text-copy-14 text-textSubtle py-2">Option 3</p>
      ...
      <Section>
        <SectionHeader id="border-between-vertical" onCopyLink={showToast}>
          Border Between Vertical
        </SectionHeader>
        <CodePreview componentCode={borderBetweenVerticalCode}>
          <Card variant="border" borderBetween row>
            <p className="text-copy-14 text-textSubtle px-2 w-full">Option 1</p>
            <p className="text-copy-14 text-textSubtle px-2 w-full">Option 2</p>
            <p className="text-copy-14 text-textSubtle px-2 w-full">Option 3</p>
      ...
      {/* Secondary */}
      <Section>
        <SectionHeader id="secondary" onCopyLink={showToast}>
          Secondary
        </SectionHeader>
        <CodePreview componentCode={secondaryCode}>
          <Card variant="secondary" borderBetween>
            <p className="text-copy-14 text-textSubtle py-2">Option 1</p>
            <p className="text-copy-14 text-textSubtle py-2">Option 2</p>
            <p className="text-copy-14 text-textSubtle py-2">Option 3</p>
