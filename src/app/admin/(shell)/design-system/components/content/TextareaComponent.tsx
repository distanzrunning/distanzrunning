...
const defaultCode = `import { Textarea } from '@/components/ui/Textarea';
...
const disabledCode = `import { Textarea } from '@/components/ui/Textarea';
import type { JSX } from 'react';
...
function DefaultDemo() {
  return <Textarea placeholder={LOREM} />;
}

function DisabledDemo() {
  return <Textarea disabled placeholder={LOREM} />;
}
