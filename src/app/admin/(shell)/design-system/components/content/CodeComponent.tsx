...
const snippetExample = `import { Snippet } from '@/components/ui/Snippet';

export function Component() {
  return <Snippet text="npm init next-app" width="300px" />;
}`;

const defaultCode = `import { Code } from '@/components/ui/Code';

export function Component() {
  return (
    <Code>{\`import { Snippet } from '@/components/ui/Snippet';
