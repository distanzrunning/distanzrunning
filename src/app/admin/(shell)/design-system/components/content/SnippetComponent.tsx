...
const defaultCode = `import { Snippet } from '@/components/ui/Snippet';

export function Component(): JSX.Element {
  return <Snippet text="npm init next-app" width={300} />;
}`;

const invertedCode = `import { Snippet } from '@/components/ui/Snippet';

export function Component(): JSX.Element {
  return <Snippet text="npm init next-app" width={300} dark />;
}`;

const multiLineCode = `import { Snippet } from '@/components/ui/Snippet';

export function Component(): JSX.Element {
  return <Snippet text={["cd project", "now"]} width="100%" />;
}`;

const noPromptCode = `import { Snippet } from '@/components/ui/Snippet';

export function Component(): JSX.Element {
  return <Snippet text="npm init next-app" width={300} prompt={false} />;
}`;

const callbackCode = `import { Snippet } from '@/components/ui/Snippet';
...
const variantsCode = `import { Snippet } from '@/components/ui/Snippet';

export function Component(): JSX.Element {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      <Snippet text="npm init next-app" width={300} variant="success" />
...
export default function SnippetComponent() {
  ...
  return (
    <>
      ...
      <Section>
        <SectionHeader id="inverted" onCopyLink={showToast}>
          Inverted
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={invertedCode}>
            <InvertedDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="multi-line" onCopyLink={showToast}>
          Multi line
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={multiLineCode}>
            <MultiLineDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="no-prompt" onCopyLink={showToast}>
          No prompt
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={noPromptCode}>
            <NoPromptDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        <SectionHeader id="callback" onCopyLink={showToast}>
          Callback
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={callbackCode}>
            <CallbackDemo />
          </CodePreview>
        </div>
      </Section>
      ...
      <Section>
        ...
        <p className="text-copy-16 text-textSubtle mt-3 mb-6" style={{ lineHeight: 1.5 }}>
          Use the <code style={{ fontSize: 13, padding: "2px 6px", borderRadius: 4, background: "var(--ds-gray-200)" }}>copied</code> prop to control the copy button animation externally. This lets you copy different text (e.g. from a context card) while reusing the snippet&apos;s checkmark feedback.
        </p>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={controlledCopiedCode}>
