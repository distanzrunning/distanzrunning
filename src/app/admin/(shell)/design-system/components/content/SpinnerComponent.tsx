...
const defaultSizeCode = `import { Spinner } from '@/components/ui/Spinner';
...
export default function SpinnerComponent() {
  ...
  return (
    <>
      <Section>
        <SectionHeader id="default-size" onCopyLink={showToast}>
          Default size
        </SectionHeader>
        <div className="mt-4 xl:mt-7">
          <CodePreview componentCode={defaultSizeCode}>
            <DefaultSizeDemo />
          </CodePreview>
        </div>
      </Section>
