...
// ============================================================================
// Section header (local copy of the shared pattern)
// ============================================================================
...
// ============================================================================
// Code preview (same wrapper pattern as Modal DS page)
// ============================================================================
  ...
  return (
    <>
      <Section>
        ...
        >
          A focused sign-up modal for the Distanz Running newsletter.
          Renders on top of the shared <code>Modal</code> (so it inherits
          focus trap, Escape to close, scrollbar compensation, and portal
          rendering), with a Berlin Marathon hero, DS <code>Input</code>,
          DS <code>Button</code>, and a green-check success state. Submits
          to <code>/api/subscribe</code> (Mailgun) and fires a PostHog{" "}
          <code>newsletter_signup</code> event on success — gated by the
          Analytics consent category via ConsentSync.
        </p>
      </Section>
      ...
      <Section>
        ...
        <p
          className="text-copy-14 text-textSubtle mt-4 mb-4"
          style={{ lineHeight: 1.5 }}
        >
          <code>NewsletterModal</code>:
        </p>
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="text-sm">
              <tr className="border-b border-borderSubtle">
                <td className="py-3 pr-4 font-mono">isOpen</td>
                <td className="py-3 px-4 font-mono">boolean</td>
                <td className="py-3 px-4 font-mono">—</td>
                <td className="py-3 px-4">Controls modal visibility.</td>
              </tr>
              <tr className="border-b border-borderSubtle">
                <td className="py-3 pr-4 font-mono">onClose</td>
                <td className="py-3 px-4 font-mono">{"() => void"}</td>
                <td className="py-3 px-4 font-mono">—</td>
                <td className="py-3 px-4">Called when the modal should close.</td>
              </tr>
              <tr>
                <td className="py-3 pr-4 font-mono">source</td>
                <td className="py-3 px-4 font-mono">string</td>
                <td className="py-3 px-4 font-mono">&quot;newsletter_modal&quot;</td>
                <td className="py-3 px-4">
                  Attribution tag passed to the PostHog signup event.
                </td>
              </tr>
            </tbody>
          </table>
