...
export function MarathonSkeleton({ isVisible, marathonName, marathonLogo, isDarkMode }: MarathonSkeletonProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 z-40 transition-colors duration-300 rounded-lg overflow-hidden"
    >
