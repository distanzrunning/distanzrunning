...
export default function WriteForUs() {
  return (
    <section className="w-full overflow-x-clip px-6 py-12">
      <div className="w-[95%] mx-auto flex flex-col px-4">
          ...
          <div className="flex grow flex-col gap-6 items-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col gap-3">
                <h4 className="font-body text-[1.75rem] md:text-[2.25rem] leading-tight font-semibold text-center text-white dark:text-gray-900">
