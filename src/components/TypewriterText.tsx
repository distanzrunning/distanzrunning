    ...
    <div className="inline-block relative max-w-full overflow-visible align-bottom">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex items-end">
          <span
            className="font-playfair text-xl md:text-2xl font-bold text-black dark:text-white whitespace-nowrap align-bottom transition-colors duration-300"
            style={{ willChange: 'contents' }}
          >
            {currentText}
          </span>
          <span
            className="text-pink-500 dark:text-pink-400 font-playfair text-xl md:text-2xl font-bold align-bottom transition-colors duration-300 animate-blink"
