      ...
      <div className="pointer-events-none fixed inset-x-0 top-0 z-40 px-16">
        <SiteNavigationMenuRoot
          triggers={
            ...
            <header className="pointer-events-auto relative mx-auto flex h-[72px] max-w-[1600px] items-center justify-between rounded-[8px] bg-[rgba(var(--ds-background-200-rgb),0.8)] p-4 transition-colors duration-[260ms] ease-out has-[[data-nav-trigger]:hover]:bg-[var(--ds-background-100)] group-data-[state=open]/menu:bg-[var(--ds-background-100)] [backdrop-filter:blur(200px)] [-webkit-backdrop-filter:blur(200px)]">
