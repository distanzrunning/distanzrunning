...
function CarouselPrevious({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute z-[2] grid size-10 place-items-center rounded-full border border-[color:var(--ds-gray-400)] bg-surface text-[color:var(--ds-gray-1000)] transition-colors hover:bg-[color:var(--ds-gray-100)] disabled:pointer-events-none disabled:opacity-50 dark:hover:bg-[color:var(--ds-gray-100)]",
        orientation === "horizontal"
