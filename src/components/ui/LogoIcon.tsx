...
//
// Icon-only Distanz mark — the Z swoosh with its two rings, no
// wordmark. Same approach as <Wordmark /> / <Logo />: inline SVG with
// fill="currentColor" so the colour follows the surrounding text
// colour (dark mode is a Tailwind text-* utility flip; zero network
// requests, no flash, no CLS — the browser knows the intrinsic aspect
// ratio from the viewBox).
//
// Source: public/brand/icon-black.svg (paths copied verbatim).
