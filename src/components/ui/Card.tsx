...
//
// Geist-faithful: the base is `rounded` (8px, = Geist's `rounded-lg`) + `p-4`
// on a surface, with the hairline supplied by the `--ds-shadow-border` token
// (no `border` — the ring lives inside the shadow, like our materials).
//
