...
function InfoIcon({ color }: { color: string }) {
  return (
    <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16" style={{ color, display: "block", minWidth: 16, verticalAlign: "middle" }}>
  ...
  (
    ...
    return (
      ...
      >
          ...
          >
            {showIcon && (
              <span style={{ display: "flex", height: 16, flexShrink: 0, marginTop: 2 }}>
